    ...
    def _generate_triggers(self, alert):
            ...
            for alert_metric in alert["metric"]:
                triggers.append(
                    CloudwatchMetricsTarget(
                        ...
                        statistic=alert_metric["statistic"],
                        statistics=alert_metric.get("statistic", "Average"),
        ...
        return [
            CloudwatchMetricsTarget(
                ...
                statistic=alert["metric"]["statistic"],
                statistics=alert["metric"].get("statistic", "Average"),
