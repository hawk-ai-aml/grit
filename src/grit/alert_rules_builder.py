    ...
    def _generate_triggers(self, alert):
            ...
            for alert_metric in alert["metric"]:
                triggers.append(
                    CloudwatchMetricsTarget(
                        ...
                        statistic=alert_metric.get("statistic", "Average"),
        ...
        return [
            CloudwatchMetricsTarget(
                ...
                statistic=alert["metric"].get("statistic", "Average"),
        ...
        rule = {
            ...
            "annotations": {
                **alert_annotation,
                ...
                "service": '{{- with $values -}}{{- $instance := "" -}}{{- range $k, $v := . -}}{{- $instance = index $v.Labels "kubernetes.container_name" -}}{{- end -}}{{ $instance }}{{- end -}}',
            },
            "labels": labels,
